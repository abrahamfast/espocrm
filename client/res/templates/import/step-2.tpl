<h4>{{translate 'Step 2' scope='Import'}}</h4>
    ...
    <div class="panel panel-default card card-bordered">
        <div class="panel-heading card-head"><h4 class="panel-title">{{translate 'Field Mapping' scope='Import'}}</h4></div>
    ...
    <div class="panel panel-default card card-bordered">
        <div class="panel-heading card-head"><h4 class="panel-title">{{translate 'Default Values' scope='Import'}}</h4></div>
        <div class="panel-body">
    ...
    <div style="padding-bottom: 10px;" class="clearfix">
        <button class="btn btn-primary pull-left" data-action="back">{{translate 'Back' scope='Import'}}</button>
