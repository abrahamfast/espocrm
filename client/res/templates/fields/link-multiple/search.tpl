...
<div class="link-group-container hidden">
    ...
    <div class="input-group add-team">
        ...
        <span class="input-group-btn">
            <button data-action="selectLink" class="btn btn-primary btn-icon btn-sm" type="button" tabindex="-1" title="{{translate 'Select'}}"><em class="icon ni ni-chevron-up-c"></em></button>
        </span>
    </div>
