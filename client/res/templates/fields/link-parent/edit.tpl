<div class="input-group input-group-link-parent">
    ...
    <span class="input-group-btn">
        <button data-action="selectLink" class="btn btn-primary btn-icon" type="button" tabindex="-1" title="{{translate 'Select'}}"><i class="fas fa-angle-up"></i></button>
        <button data-action="clearLink" class="btn btn-primary btn-icon" type="button" tabindex="-1"><i class="fas fa-times"></i></button>
    </span>
    {{else}}
    {{translate 'None'}}
    {{/if}}
